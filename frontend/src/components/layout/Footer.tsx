        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-12 text-center md:text-left">
          ...
          <div className="col-span-1 md:col-span-1 flex flex-col items-center md:items-start">
            ...
            <div className="flex space-x-4 justify-center md:justify-start">
              <a href="#" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-km-gold transition-colors">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3 font-dm text-sm text-km-text-3">
              <li><Link to="/products?category=new-drops" className="hover:text-km-gold transition-colors block md:inline">New Drops</Link></li>
              <li><Link to="/products?category=formal-collection" className="hover:text-km-gold transition-colors block md:inline">Formal Collection</Link></li>
              <li><Link to="/products?category=casual-collection" className="hover:text-km-gold transition-colors block md:inline">Casual Collection</Link></li>
              <li><Link to="/products?category=best-selling" className="hover:text-km-gold transition-colors block md:inline">Best Sellers</Link></li>
              <li><Link to="/products?category=peshawari-sandals" className="hover:text-km-gold transition-colors block md:inline">Peshawari Sandals</Link></li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3 font-dm text-sm text-km-text-3">
              <li><Link to="/" className="hover:text-white transition-colors block md:inline">Contact Us</Link></li>
              <li><Link to="/" className="hover:text-white transition-colors block md:inline">Shipping Policy</Link></li>
              <li><Link to="/" className="hover:text-white transition-colors block md:inline">Returns & Exchanges</Link></li>
              <li><Link to="/" className="hover:text-white transition-colors block md:inline">Track Order</Link></li>
              <li><Link to="/" className="hover:text-white transition-colors block md:inline">Size Guide</Link></li>
            </ul>
          </div>
