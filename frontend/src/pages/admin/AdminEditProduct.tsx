...
const AdminEditProduct: React.FC = () => {
  ...
  if (initialLoading) {
    return <div className="p-12 text-center text-km-text-3 font-dm animate-pulse">Loading product...</div>;
  }
  ...
  return (
    <div className="max-w-5xl mx-auto pb-12 font-dm">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="font-playfair text-km-text text-3xl font-semibold tracking-wide">Edit Product</h1>
          <p className="text-km-text-2 mt-2 text-sm tracking-wider">Update product details</p>
        </div>
        <button
          type="button"
